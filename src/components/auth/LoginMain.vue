<template>
 <main class="pb-16 pt-16 bg-teal-lighten-5">
    <v-card class="mx-auto pa-13 pb-8 " elevation="8" max-width="448" rounded="lg">
        ...
        <v-text-field :append-inner-icon="visible ? 'mdi-eye-off' : 'mdi-eye'" :type="visible ? 'password' : 'text'" density="compact" placeholder="password..." prepend-inner-icon="mdi-lock-outline"
                variant="outlined" v-model="user.pwd"  @click:append-inner="toggleVisibility"></v-text-field>
        ...
        <div class="text-center mb-5">
            <a class="text-blue text-decoration-none" href="#" rel="noopener noreferrer" target="_blank" @click.prevent="Register()">
