  ...
  <v-container>
    <v-row class="box-container">
      ...
      <v-col cols="12" md="6" class="mt-6">
        ...
        <div class="mt-6 fz-12" style="color: #C62828" v-show="count > 5"> <v-icon>mdi-alert</v-icon> {{ product.notice[0] }}
        </div>
        <div class="mt-6 d-flex justify-space-between">
          <v-btn color="error" width="48%" variant="flat" @click.stop='addToCart(item)'>加入購物車</v-btn>
  ...
  data() {
    return {
      ...
      product: {
        ...
        description: 'Perpetual1908現提供950鉑金款式，配備冰藍色錶面。冰藍色是我們專為950鉑金腕錶設計的色彩。錶面飾有穀粒紋，立體圖案流轉靈動光澤，舉手投足間光芒四射。新款1908別具匠心，個性鮮明，可謂賞心悅目的傑作。',
        descriptionItem: [
          {
        ...
        notice:['此商品為近期熱門因此每隻帳號限購五隻', '商品訂購後, 開始製作, 需等待30天工作日'],
